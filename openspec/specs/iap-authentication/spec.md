...
Secure public-facing endpoints with Google Cloud Identity-Aware Proxy (IAP). All traffic to the UI and API must pass through IAP authentication and the backend validates IAP JWT assertions as a defense-in-depth measure.
